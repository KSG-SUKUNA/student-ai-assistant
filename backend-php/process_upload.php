...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    (student_id, stage, media_type, file_path, result_image_path, engagement_score, engagement_level, recommended_aid)
    VALUES (
        '$student_id',
        '$stage',
        'image',
    ...
    header("Location: dashboard_student.php?id=" . $student_id);
}
?>